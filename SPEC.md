...
- Consistent directory structure and naming conventions across all 127 modules.
...
| Stale module/tool counts in docs | **Resolved v1.1.1** | — | Updated: 127 modules, 545 `@mcp_tool` decorators across auto-discovered modules |
