...
This example demonstrates tools functionality using the Codomyrmex `tools` module.
...
Functional requirements for tools including core capabilities and standards.
...
Implementation guidelines for working within tools including best practices and patterns.
