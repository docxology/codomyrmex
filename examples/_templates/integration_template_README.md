...
cp examples/_templates/integration_template.py examples/multi_module/{integration_name}/example_basic.py
cp examples/_templates/integration_template_config.yaml examples/multi_module/{integration_name}/config.yaml
cp examples/_templates/integration_template_README.md examples/multi_module/{integration_name}/README.md
```
