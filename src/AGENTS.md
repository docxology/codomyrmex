...
Core source code directory containing all Codomyrmex modules. This is the primary implementation surface with 130 specialized modules organized by architectural layer.
...
| ------------------------ | ------- | --------------------------------------------- |
| `codomyrmex/`            | Package | Main module package (130 modules)             |
