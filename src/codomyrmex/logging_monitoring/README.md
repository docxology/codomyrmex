...
graph TD
    ...
    RootLogger --> CoreLogger["Core Layer<br/>ai_code_editing<br/>static_analysis<br/>code<br/>data_visualization<br/>pattern_matching<br/>git_operations"]
    ...
    ServiceLogger --> SpecializedLogger["Specialized Layer<br/>system_discovery<br/>module_template<br/>spatial.three_d"]
