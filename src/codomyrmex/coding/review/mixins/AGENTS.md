...
- `architecture.py` – Project file
- `codesmells.py` – Project file
- `complexity.py` – Project file
- `deadcode.py` – Project file
- `metrics.py` – Project file
- `performance.py` – Project file
- `pyscn.py` – Project file
- `refactoring.py` – Project file
- `reporting.py` – Project file
- `traditional.py` – Project file
