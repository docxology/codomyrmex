...
def resource_limits_context(limits: ExecutionLimits) -> Generator[None, None, None]:
    ...
    try:
        ...
        # Avoid enforcing strict resource.RLIMIT_AS memory limits on the main Python process,
        # as it causes MemoryError when spawning threads or subprocesses in unit testing.
        # Instead, limits are enforced strictly in the subprocess context below.
