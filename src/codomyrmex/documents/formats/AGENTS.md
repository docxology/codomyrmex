...
- `json_handler.py` - Component file.
- `markdown_handler.py` - Component file.
- `pdf_handler.py` - Component file.
- `text_handler.py` - Component file.
- `yaml_handler.py` - Component file.
