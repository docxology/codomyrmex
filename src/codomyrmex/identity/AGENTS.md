# Codomyrmex Agents — src/codomyrmex/identity
...
- `biocognitive.py` – Biocognitive implementation
- `identity.py` – Identity implementation
- `manager.py` – Manager implementation
- `mcp_tools.py` – MCP tool implementations — tool handlers and schemas
- `persona.py` – Persona implementation
