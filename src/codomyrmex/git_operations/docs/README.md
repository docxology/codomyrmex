...
Container for the `src/codomyrmex/git_operations/docs` agent surfaces and supporting assets.
...
from codomyrmex.src.codomyrmex.git_operations.docs import ModuleClass
