...
def create_github_repository(name: str, private: bool = True, description: str = "",
                           github_token: Optional[str] = None, 
                           auto_init: bool = True, gitignore_template: str = "Python",
                           license_template: str = "mit") -> Dict:
    """
...
def delete_github_repository(owner: str, repo_name: str, 
...
def create_pull_request(repo_owner: str, repo_name: str, head_branch: str,
    ...
    logger.info(f"Creating PR in {repo_owner}/{repo_name}: {head_branch} -> {base_branch}")
...
def get_pull_requests(repo_owner: str, repo_name: str, state: str = "open",
...
def get_pull_request(repo_owner: str, repo_name: str, pr_number: int,
                   github_token: Optional[str] = None) -> Dict:
    """
...
def get_repository_info(repo_owner: str, repo_name: str,
                      github_token: Optional[str] = None) -> Dict:
    """
...
if __name__ == "__main__":
    ...
    try:
        ...
        logger.info("Set GITHUB_TOKEN environment variable to test GitHub API functions")
