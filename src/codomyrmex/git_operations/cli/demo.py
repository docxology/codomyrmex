...
class GitVisualizationDemo:
    ...
    def run_all_demos(
        ...
        if repository_path:
            ...
            logger.info(
                "No repository path provided. Skipping real repository analysis."
            )
        ...
        logger.info(
            "Demo run completed. Successful: %s/%s", success_count, len(results)
        )
    ...
    def demo_sample_data_visualizations(self) -> bool:
        ...
        sample_commits = [
            ...
            {
                "hash": "m1n2o3p",
                "message": "Implement login system",
                "author_name": "Bob",
                "author_email": "bob@example.com",
        ...
        sample_workflow_steps = [
            ...
            {"name": "Clone", "type": "process", "description": "git clone repository"},
            {
                "name": "Branch",
                "type": "process",
                "description": "git checkout -b feature/name",
            },
            ...
            },
            {
                "name": "Push",
                "type": "process",
                "description": "git push origin feature/name",
            },
        ...
        sample_repo_structure = {
            "src": {
                "codomyrmex": {
                    "data_visualization": {"__init__.py": "file", "plotter.py": "file"},
                    "git_operations": {"__init__.py": "file", "git_manager.py": "file"},
                }
            },
            "docs": {"README.md": "file"},
            "setup.py": "file",
        ...
        results["git_tree_mermaid"] = bool(
            visualizer.visualize_git_tree_mermaid(
                branches=sample_branches,
                commits=sample_commits,
        ...
        results["workflow_diagram"] = bool(
            mermaid_generator.create_git_workflow_diagram(
        ...
        results["structure_diagram"] = bool(
            mermaid_generator.create_repository_structure_diagram(
    ...
    def _generate_overall_summary(
        self, results: dict[str, bool], repository_path: str | None
    ):
