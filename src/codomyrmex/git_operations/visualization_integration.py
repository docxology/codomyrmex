    ...
    workflow_steps = {
        ...
        "gitflow": [
            ...
            },
            {
                "name": "Main",
                "type": "process",
                "description": "main branch (production)",
            },
...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1:
        ...
        branch_result = visualize_git_branches(
            repository_path=repo_path, output_path="./test_branches.png"
        )
        ...
        activity_result = visualize_commit_activity(
            repository_path=repo_path, output_path="./test_activity.png"
        )
    ...
    if not logger.hasHandlers():
        ...
        logger.info(
            "Basic logging configured for direct script execution of visualization_integration.py."
        )
