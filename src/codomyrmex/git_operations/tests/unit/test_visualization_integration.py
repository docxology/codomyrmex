...
class TestGitAnalysisReport:
    ...
    @patch('codomyrmex.git_operations.visualization_integration.VISUALIZATION_AVAILABLE', False)
    ...
    @patch('codomyrmex.git_operations.visualization_integration.VISUALIZATION_AVAILABLE', True)
    ...
    def test_create_git_analysis_report_not_git_repo(self, mock_is_repo, mock_git_available):
    ...
    def test_create_git_analysis_report_success(self, mock_visualizer_class, mock_is_repo, mock_git_available):
    ...
    @patch('codomyrmex.git_operations.visualization_integration.is_git_repository')
    @patch('codomyrmex.git_operations.visualization_integration.GitVisualizer')
    def test_create_git_analysis_report_with_filters(self, mock_visualizer_class, mock_is_repo, mock_git_available):
...
class TestBranchVisualization:
    ...
    @patch('codomyrmex.git_operations.visualization_integration.is_git_repository')
    @patch('codomyrmex.git_operations.visualization_integration.GitVisualizer')
    def test_visualize_git_branches_png_success(self, mock_visualizer_class, mock_is_repo):
    ...
    @patch('codomyrmex.git_operations.visualization_integration.is_git_repository')
    @patch('codomyrmex.git_operations.visualization_integration.GitVisualizer')
    def test_visualize_git_branches_mermaid_success(self, mock_visualizer_class, mock_is_repo):
    ...
    def test_visualize_git_branches_unsupported_format(self):
        ...
        with patch('codomyrmex.git_operations.visualization_integration.VISUALIZATION_AVAILABLE', True):
            with patch('codomyrmex.git_operations.visualization_integration.is_git_repository') as mock_is_repo:
                mock_is_repo.return_value = True
...
class TestCommitActivityVisualization:
    ...
    @patch('codomyrmex.git_operations.visualization_integration.is_git_repository')
    @patch('codomyrmex.git_operations.visualization_integration.GitVisualizer')
    def test_visualize_commit_activity_success(self, mock_visualizer_class, mock_is_repo):
        ...
        result = visualize_commit_activity(
            repository_path=self.test_dir,
            days_back=14
        )
...
class TestWorkflowDiagram:
    ...
    @patch('codomyrmex.git_operations.visualization_integration.VISUALIZATION_AVAILABLE', True)
    @patch('codomyrmex.git_operations.visualization_integration.create_git_workflow_diagram')
...
class TestRepositoryStructureAnalysis:
    ...
    @patch('codomyrmex.git_operations.visualization_integration.VISUALIZATION_AVAILABLE', True)
    @patch('codomyrmex.git_operations.visualization_integration.is_git_repository')
    @patch('codomyrmex.git_operations.visualization_integration.create_repository_structure_diagram')
    def test_analyze_repository_structure_success(self, mock_create_structure, mock_is_repo):
...
class TestRepositoryMetadata:
    ...
    def test_get_repository_metadata_success(self, mock_stashes, mock_commits, mock_status, mock_branch, mock_is_repo):
        ...
        assert result["commit_stats"]["top_authors"][0] == ("Alice", 2)  # Alice has 2 commits
...
class TestUtilityFunctions:
    ...
    def test_analyze_directory_structure_max_depth(self):
        ...
        with open(os.path.join(self.test_dir, "level1", "level2", "level3", "deep.txt"), 'w') as f:
            f.write("deep file")
    ...
    def test_get_created_files(self):
        ...
        assert expected_files[3] in files  # README should always be included if it exists
        
        # repo_summary file should not be included since results[repo_summary] = False
        repo_summary_file = os.path.join(output_dir, "test_report_summary_dashboard.png")
