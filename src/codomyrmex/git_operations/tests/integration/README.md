...
Container for the `src/codomyrmex/git_operations/tests/integration` agent surfaces and supporting assets.
...
from codomyrmex.src.codomyrmex.git_operations.tests.integration import ModuleClass
