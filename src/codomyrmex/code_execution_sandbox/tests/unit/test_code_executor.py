...
class TestValidators(unittest.TestCase):
    ...
    def test_validate_timeout(self):
        ...
        self.assertEqual(
            validate_timeout(1000), 300
        )  # Should be normalized to MAX_TIMEOUT
...
class TestExecuteCode(unittest.TestCase):
    ...
    def test_successful_execution(
        self, mock_cleanup, mock_run, mock_stdin, mock_code_file, mock_check_docker
    ):
    ...
    @patch("code_execution_sandbox.code_executor.run_code_in_docker")
    @patch("code_execution_sandbox.code_executor.cleanup_temp_files")
    def test_execution_without_stdin(
        self, mock_cleanup, mock_run, mock_code_file, mock_check_docker
    ):
        ...
        result = execute_code(
            language="python", code="print('Hello, World!')", timeout=10
        )
    ...
    def test_exception_handling(self, mock_cleanup, mock_code_file, mock_check_docker):
        ...
        # Execute code
        result = execute_code(language="python", code="print('Hello, World!')")
