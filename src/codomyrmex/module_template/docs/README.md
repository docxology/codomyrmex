...
Container for the `src/codomyrmex/module_template/docs` agent surfaces and supporting assets.
...
from codomyrmex.src.codomyrmex.module_template.docs import ModuleClass
