# Codomyrmex Agents — src/codomyrmex/module_template/tests/integration

## Purpose
Integration tests for module template workflows, validating end-to-end workflows and cross-component interactions with realistic test scenarios.
...
- Integration tests validate module template workflows across multiple components.
