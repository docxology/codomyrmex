# src/codomyrmex/module_template/tests/integration

**Version**: v0.1.0 | **Status**: Active | **Last Updated**: October 2025

## Overview

Container for the `src/codomyrmex/module_template/tests/integration` agent surfaces and supporting assets.
...
from codomyrmex.src.codomyrmex.module_template.tests.integration import ModuleClass
