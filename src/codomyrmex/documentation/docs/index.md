...
- **Explore Modules**: Dive into the specifics of each [module](./modules/) to understand its capabilities and how it fits into the Codomyrmex ecosystem.
- **Development Setup**: Learn how to set up your environment for contributing or using Codomyrmex with the [Environment Setup Guide](./development/environment-setup.md).
- **Contributing**: Interested in contributing? Check out the [Contributing Guidelines](./project/contributing.md).
