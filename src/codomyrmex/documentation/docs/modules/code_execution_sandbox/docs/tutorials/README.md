# src/codomyrmex/documentation/docs/modules/code_execution_sandbox/docs/tutorials
...
from codomyrmex.src.codomyrmex.documentation.docs.modules.code_execution_sandbox.docs.tutorials import ModuleClass
