# src/codomyrmex/documentation/docs/modules/template/docs/tutorials
...
from codomyrmex.src.codomyrmex.documentation.docs.modules.template.docs.tutorials import ModuleClass
