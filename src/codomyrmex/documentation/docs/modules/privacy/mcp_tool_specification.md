...
2.  For each tool you define, copy the "Tool: `privacy_tool`" section.
3.  Replace all bracketed placeholders (e.g., `privacy_tool`, `[Brief description...]`, `[ParameterName]`, `[DataType]`, etc.) with specific details for your tool.
