# Exceptions -- Technical Specification
...
- The module shall provide exceptions capabilities as described in the module docstring.
- The module shall export 76 public symbols via `__all__`.
