# Templating -- Technical Specification
...
- The module shall provide templating capabilities as described in the module docstring.
...
- **Source**: [src/codomyrmex/templating/](../../../../templating/)
