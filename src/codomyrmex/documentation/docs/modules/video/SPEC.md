...
- The module shall provide video capabilities as described in the module docstring.
- The module shall export 28 public symbols via `__all__`.
...
- **Source**: [src/codomyrmex/video/](../../../../video/)
