# Spatial -- Technical Specification
...
- The module shall provide spatial capabilities as described in the module docstring.
...
- **Source**: [src/codomyrmex/spatial/](../../../../spatial/)
