...
| VERIFY | Health checks validate module importability, test presence, and doc completeness |
...
| `CapabilityScanner` | class | Advanced scanner for functions, classes, and methods across the ecosystem |
...
| `cli_commands` | function | Returns CLI command definitions for this module |
