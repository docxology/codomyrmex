# Codomyrmex Agents — src/codomyrmex/documentation/tests/integration

## Purpose
Integration tests for documentation workflows, validating end-to-end workflows and cross-component interactions with realistic test scenarios.
...
- Integration tests validate documentation workflows across multiple components.
- Test execution maintains realistic scenarios and comprehensive workflow coverage.

## Related Modules
- **Documentation Tests** (`../`) - Parent test directory
