...
class ConfigValidator:
    ...
    # ⚡ Bolt: Hoisted from _check_type to prevent per-call dictionary allocation overhead.
    # This optimization slightly improves memory usage and CPU time during validation.
    _TYPE_MAP = {
        "str": str,
        "int": int,
        "float": float,
