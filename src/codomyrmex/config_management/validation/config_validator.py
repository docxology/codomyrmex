...
class ConfigValidator:
    ...
    # Optimization: Hoisted static dictionary to class level to avoid per-call allocation overhead
    # Impact: Reduces memory allocations and improves performance in frequently called _check_type
    _TYPE_MAP = {
        "str": str,
        "int": int,
        "float": float,
