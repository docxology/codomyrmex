...
FRAMEWORKS = {
    "owasp_top_10": SecurityFramework(
        ...
        version="2021",
        categories=[
            FrameworkCategory.WEB_SECURITY.value,
            FrameworkCategory.APPLICATION_SECURITY.value,
        ],
        standards=[
    ...
    "nist_csf": SecurityFramework(
        ...
        version="1.1",
        categories=[
            FrameworkCategory.CYBERSECURITY.value,
            FrameworkCategory.RISK_MANAGEMENT.value,
        ],
    ...
    "iso_27001": SecurityFramework(
        ...
        version="2022",
        categories=[
            FrameworkCategory.INFORMATION_SECURITY.value,
            FrameworkCategory.COMPLIANCE.value,
        ],
        standards=[
...
def apply_framework(framework_name: str, context: dict[str, Any]) -> dict[str, Any]:
    ...
    logger.info(
        f"Applying framework '{framework.name}' version {framework.version} to context"
    )
    ...
    if framework_name == "owasp_top_10":
        ...
        recommendations.append(
            "Implement Identify function: Asset management and risk assessment"
        )
        recommendations.append(
            "Implement Protect function: Access control and data security"
        )
        recommendations.append(
            "Implement Detect function: Security monitoring and detection"
        )
        recommendations.append("Implement Respond function: Incident response planning")
        recommendations.append(
            "Implement Recover function: Recovery planning and improvements"
        )
...
def check_framework_compliance(
    framework_name: str, context: dict[str, Any]
) -> dict[str, Any]:
    """
    ...
    framework = FRAMEWORKS.get(framework_name)
    if not framework:
        return {"compliant": False, "error": f"Unknown framework: {framework_name}"}
