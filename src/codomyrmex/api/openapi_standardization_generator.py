"""OpenAPI standardization generator for REST API standardization.

This module contains the StandardizationOpenAPIGenerator class, which creates
OpenAPI specifications from REST/GraphQL API framework instances.
