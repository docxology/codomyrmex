...
Container for the `src/codomyrmex/build_synthesis/tests/unit` agent surfaces and supporting assets.
...
from codomyrmex.src.codomyrmex.build_synthesis.tests.unit import ModuleClass
