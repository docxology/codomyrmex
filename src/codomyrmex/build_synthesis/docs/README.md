...
Container for the `src/codomyrmex/build_synthesis/docs` agent surfaces and supporting assets.
...
from codomyrmex.src.codomyrmex.build_synthesis.docs import ModuleClass
