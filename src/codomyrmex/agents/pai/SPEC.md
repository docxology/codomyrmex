...
Comprehensive bridge to the PAI (Personal AI Infrastructure) system. Provides programmatic access to all PAI subsystems at `~/.claude/PAI/` (v4+; v3 installation: `~/.claude/skills/PAI/`).
