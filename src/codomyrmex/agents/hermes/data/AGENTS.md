...
# Codomyrmex Agents — src/codomyrmex/agents/hermes/data

**Version**: v0.1.0 | **Status**: Active | **Last Updated**: April 2026

## Signposting

- **Path**: `src/codomyrmex/agents/hermes/data`
- **Human overview**: [README.md](README.md)
- **Functional spec**: [SPEC.md](SPEC.md)
- **Agent coordination** (repo root): [../../../../../AGENTS.md](../../../../../AGENTS.md)
## Purpose
Package data (e.g. bundled skill registry YAML).

## Active Components
- Markdown `README.md`
- Markdown `SPEC.md`
- Python source `__init__.py`
- Config/data `skills_registry.yaml`
