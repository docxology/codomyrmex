...
def parse_code_blocks(text: str, language: Optional[str] = None) -> list[CodeBlock]:
    """
...
def parse_first_code_block(text: str, language: Optional[str] = None) -> Optional[CodeBlock]:
