# Data Lineage - MCP Tool Specification Template

This document serves as a template for defining tools within the `Data Lineage` module that are intended to be integrated with the Model Context Protocol (MCP).

**Instructions for Use:**
1.  Replace `Data Lineage` in the title above and throughout this document with the actual name of your module.
2.  For each tool you define, copy the "Tool: `data_lineage_tool`" section.
3.  Replace all bracketed placeholders (e.g., `data_lineage_tool`, `[Brief description...]`, `[ParameterName]`, `[DataType]`, etc.) with specific details for your tool.
...
## Tool: `data_lineage_tool`

### 1. Tool Purpose and Description

Provenance tracking and dependency mapping via MCP
...
- **Return Format on Error**: Reiterate or specify the error object format (e.g., `{"error": "Specific error message related to data_lineage_tool", "details": {...}}`).
...
---
<!-- Add more tool specifications below by copying the "Tool: `data_lineage_tool`" section. --> 