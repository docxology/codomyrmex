...
# Codomyrmex Agents — src/codomyrmex/plugin_system/wasm

**Version**: v0.1.0 | **Status**: Active | **Last Updated**: April 2026

## Signposting

- **Path**: `src/codomyrmex/plugin_system/wasm`
...
## Navigation Links
- **Parent directory**: [plugin_system](../README.md) — parent folder overview
