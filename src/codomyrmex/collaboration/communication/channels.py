...
from ..exceptions import ChannelError, MessageDeliveryError
...
class Channel(ABC):
    ...
    def __init__(self, channel_id: Optional[str] = None, name: str = "Channel"):
...
class MessageQueue:
    ...
    def get_nowait(self) -> Optional[AgentMessage]:
