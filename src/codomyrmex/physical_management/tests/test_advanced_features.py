...
from codomyrmex.physical_management import (
    ...
    MaterialType, MaterialProperties, EventType, ObjectEvent,
    SpatialIndex, ObjectRegistry
)
...
class TestTagSystem:
    ...
    def test_get_objects_by_tags_match_all(self):
        ...
        temp_sensors = registry.get_objects_by_tags({"sensor", "temperature"}, match_all=True)
        ...
        outdoor_temp = registry.get_objects_by_tags({"sensor", "temperature", "outdoor"}, match_all=True)
    ...
    def test_get_objects_by_tags_match_any(self):
        ...
        sensors = registry.get_objects_by_tags({"temperature", "humidity"}, match_all=False)
...
class TestNetworkTopology:
    ...
    def test_network_metrics(self):
        ...
        assert metrics["total_connections"] == 3  # Each bidirectional connection counted once
