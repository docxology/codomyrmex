    ...
    def test_analyze_project_specific_paths(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with patch.object(analyzer, 'analyze_file') as mock_analyze:
                ...
                summary = analyzer.analyze_project(target_paths=[os.path.join(temp_dir, "test1.py")])
...
class TestResultFiltering:
    ...
    def test_get_results_by_severity(self):
        ...
        analyzer.results = [
            ...
            AnalysisResult("file3.py", 3, 0, SeverityLevel.ERROR, "Error", "E001", "test"),
        ]
    ...
    def test_get_results_by_category(self):
        ...
        # Add test results
        analyzer.results = [
            AnalysisResult("file1.py", 1, 0, SeverityLevel.INFO, "Info", "I001", "pylint"),
            AnalysisResult("file2.py", 2, 0, SeverityLevel.WARNING, "Warning", "W001", "flake8"),
            AnalysisResult("file3.py", 3, 0, SeverityLevel.ERROR, "Error", "E001", "pylint"),
        ]
    ...
    def test_get_results_by_file(self):
        ...
        analyzer.results = [
            AnalysisResult("file1.py", 1, 0, SeverityLevel.INFO, "Info", "I001", "test"),
            AnalysisResult("file2.py", 2, 0, SeverityLevel.WARNING, "Warning", "W001", "test"),
            AnalysisResult("file1.py", 3, 0, SeverityLevel.ERROR, "Error", "E001", "test"),
        ]
...
class TestConvenienceFunctions:
    ...
    def test_analyze_file_function(self):
        ...
        try:
            with patch('static_analysis.static_analyzer.StaticAnalyzer.analyze_file') as mock_analyze:
                mock_results = [AnalysisResult("test.py", 1, 0, SeverityLevel.INFO, "Test", "T001", "test")]
                mock_analyze.return_value = mock_results
    ...
    def test_analyze_project_function(self):
        ...
        with patch('static_analysis.static_analyzer.StaticAnalyzer.analyze_project') as mock_analyze:
