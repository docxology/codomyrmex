...
class InfomaniakIdentityClient(InfomaniakOpenStackBase):
    ...
    def get_application_credential(self, credential_id: str) -> Optional[Dict[str, Any]]:
    ...
    def list_user_roles(self, project_id: Optional[str] = None) -> List[Dict[str, Any]]:
    ...
    def create_ec2_credentials(
        ...
        try:
            ...
            cred = self._conn.identity.create_credential(
                ...
                blob=f'{{"access": "", "secret": ""}}'  # Keystone generates these
            )
