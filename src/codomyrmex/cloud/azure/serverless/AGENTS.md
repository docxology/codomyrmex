...
Azure serverless function and event-driven compute services. Provides abstracted interfaces for managing Azure Functions, Logic Apps, Event Grid through the Codomyrmex cloud common layer.
