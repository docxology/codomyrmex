# GCP Serverless - Agents

**Version**: v1.0.0 | **Status**: Active | **Last Updated**: February 2026

## Purpose

GCP serverless function and event-driven compute services. Provides abstracted interfaces for managing Cloud Functions, Cloud Workflows, Eventarc through the Codomyrmex cloud common layer.
