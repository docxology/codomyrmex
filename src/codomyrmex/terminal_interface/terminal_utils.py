...
class TerminalFormatter:
    ...
    def box(self, content: str, title: Optional[str] = None, 
        ...
        if title:
            ...
            top_line = "─" * padding + title_part + "─" * (width - len(title_part) - padding)
...
class CommandRunner:
    ...
    def run_command(self, command: List[str], cwd: Optional[Path] = None,
                   show_output: bool = True, timeout: Optional[int] = None) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            if show_output:
                if success:
                    ...
                    print(self.formatter.error(f"Command failed with exit code {returncode}"))
    ...
    def run_python_module(self, module: str, args: List[str] = None, 
                         cwd: Optional[Path] = None, show_output: bool = True) -> Dict[str, Any]:
