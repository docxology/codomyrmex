...
class TestResourceManager:
    ...
    def test_add_resource_duplicate(self, resource_manager):
        ...
        assert resource_manager.resources["cpu_1"] == resource1  # Original should remain
    ...
    def test_list_resources_by_type(self, resource_manager):
        ...
        mem_resources = resource_manager.list_resources(resource_type=ResourceType.MEMORY)
...
class TestResourceManagerConcurrency:
    ...
    def test_concurrent_allocations(self):
        ...
        # Check results
        successful_allocations = sum(1 for result in results.values() if result is not None)
