...
class TestWorkflowManager:
    ...
    def test_workflow_manager_initialization(self, temp_dir):
        ...
        manager = WorkflowManager(config_dir=temp_dir, enable_performance_monitoring=False)
...
class TestWorkflowManagerIntegration:
    ...
    def test_full_workflow_lifecycle(self, workflow_manager, temp_dir):
        ...
        new_manager = WorkflowManager(config_dir=temp_dir, enable_performance_monitoring=False)
    ...
    def test_workflow_with_complex_dependencies(self, workflow_manager):
        ...
        steps = [
            ...
            WorkflowStep(name="step3", module="module3", action="action3", dependencies=["step1"]),
            WorkflowStep(name="step4", module="module4", action="action4", dependencies=["step2", "step3"]),
        ]
