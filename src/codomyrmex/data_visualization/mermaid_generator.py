...
"""
    ...
    def _build_structure_from_data(
        ...
        def add_structure_nodes(parent_id: str, parent_name: str, structure: Dict[str, Any], level: int = 0):
...
def create_repository_structure_diagram(
    ...
    generator = MermaidDiagramGenerator()
    return generator.create_repository_structure_diagram(repo_structure, title, output_path)
...
if __name__ == '__main__':
    ...
    sample_commits = [
        {"hash": "a1b2c3d", "message": "Initial commit", "branch": "main", "date": "2024-01-01"},
        {"hash": "e4f5g6h", "message": "Add authentication", "branch": "feature/auth", "date": "2024-01-03"},
        {"hash": "i7j8k9l", "message": "Fix auth bug", "branch": "feature/auth", "date": "2024-01-04"}
    ]
    ...
    if not get_codomyrmex_logger('').hasHandlers():
        ...
        logger.info("Basic logging configured for direct script execution of mermaid_generator.py.")
