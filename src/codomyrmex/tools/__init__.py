...
from .analyze_project import analyze_project_structure, analyze_dependencies as analyze_project_dependencies, analyze_code_quality, generate_report as generate_analysis_report, main as analyze_project_main
from .dependency_analyzer import DependencyAnalyzer, main as dependency_analyzer_main
from .dependency_checker import check_dependencies, main as dependency_checker_main
from .dependency_consolidator import analyze_dependencies as consolidate_dependencies, main as dependency_consolidator_main
from .validate_dependencies import main as validate_dependencies_main
from .add_deprecation_notices import add_deprecation_notice, main as add_deprecation_notices_main
