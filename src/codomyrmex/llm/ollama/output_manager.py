...
class OutputManager:
    ...
    def save_execution_result(
        self, result: ModelExecutionResult, output_dir: str | None = None
    ) -> str:
        """
    ...
    def save_model_config(
        self, model_name: str, config: dict[str, Any], config_name: str | None = None
    ) -> str:
        """
    ...
    def load_model_config(
        self, model_name: str, config_name: str | None = None
    ) -> dict[str, Any] | None:
        """
    ...
    def save_model_comparison(
        self, comparison_results: dict[str, Any], output_dir: str | None = None
    ) -> str:
        """
            ...
            for item in search_dir.iterdir():
                if item.is_file() and item.suffix == ".json":
                    try:
                        ...
                        if model_name:
                            if (output_type == "outputs" and "model_name" in data) or (
                                output_type == "configs" and "model_name" in data
                            ):
