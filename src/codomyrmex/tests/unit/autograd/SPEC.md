# Autograd Test Specification

**Version**: v1.1.9 | **Status**: Active | **Last Updated**: March 2026

## Overview

Specification for the `autograd` test suite.
...
1. All public API methods in `autograd` must have at least one test
...
**Requires**: `pytest`, `uv sync --extra autograd` (if module has optional deps)
