# Codomyrmex Agents — src/codomyrmex/tests/unit/module_template

**Version**: v0.1.0 | **Status**: Active | **Last Updated**: March 2026

## Purpose
Validation coverage, fixtures, and regression checks for Module Template.
...
- `test_scaffold.py` – Project file
- `test_scaffold_comprehensive.py` – Project file
...
- `test_scaffold.py`
- `test_scaffold_comprehensive.py`
