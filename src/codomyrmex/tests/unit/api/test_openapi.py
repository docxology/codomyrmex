"""Comprehensive tests for codomyrmex.api.openapi_generator module.

Covers APISchema, OpenAPISpecification, DocumentationOpenAPIGenerator,
StandardizationOpenAPIGenerator, and all convenience functions with
focus on gaps not covered by test_api.py.
"""
