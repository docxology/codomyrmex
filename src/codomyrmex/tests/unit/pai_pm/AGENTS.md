# Codomyrmex Agents — src/codomyrmex/tests/unit/pai_pm

**Version**: v0.1.0 | **Status**: Active | **Last Updated**: March 2026

## Purpose
Validation coverage, fixtures, and regression checks for Pai Pm.

## Active Components
- `README.md` – Project file
- `__init__.py` – Project file
- `conftest.py` – Project file
- `test_client.py` – Project file
- `test_config.py` – Project file
- `test_exceptions.py` – Project file
- `test_mcp_tools.py` – Project file
- `test_server_manager.py` – Project file
