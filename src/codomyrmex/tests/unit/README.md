...
- `test_ollama_integration_README.md` – File
- `test_ollama_integration_comprehensive.py` – File
- `tools/` – Subdirectory
...
```python
# Example usage
from codomyrmex.codomyrmex.tests.unit import main_component
