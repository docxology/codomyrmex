# PEFT (Parameter-Efficient Fine-Tuning) Test Specification

**Version**: v1.1.0 | **Status**: Active | **Last Updated**: March 2026

## Overview

Specification for the `peft` test suite.
...
1. All public API methods in `peft` must have at least one test
...
**Requires**: `pytest`, `uv sync --extra peft` (if module has optional deps)
