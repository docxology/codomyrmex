# Eval Harness Tests -- Agent Coordination

**Version**: v1.1.9 | **Status**: Active | **Last Updated**: March 2026

## Overview

Test suite for the `eval_harness` module, implementing the zero-mock testing policy.
...
1. Run this test suite after any changes to `src/codomyrmex/eval_harness/`
...
- [README.md](README.md) | [SPEC.md](SPEC.md) | [Source](../../../../eval_harness/)
