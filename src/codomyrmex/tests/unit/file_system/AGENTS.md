# File System Tests -- Agent Coordination

**Version**: v1.1.0 | **Status**: Active | **Last Updated**: March 2026

## Overview

Test suite for the `file_system` module, implementing the zero-mock testing policy.
...
1. Run this test suite after any changes to `src/codomyrmex/file_system/`
...
- [README.md](README.md) | [SPEC.md](SPEC.md) | [Source](../../../../file_system/)
