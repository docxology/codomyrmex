...
import time
import asyncio
from codomyrmex.events import Event, EventBus, EventType, EventPriority
...
class TestEventBusReview:
    ...
    def test_wildcard_subscriptions(self, event_bus):
        ...
        received = []
        event_bus.subscribe(["system.*"], lambda e: received.append(e))
    ...
    def test_event_filtering(self, event_bus):
        ...
        event_bus.subscribe(["*"], lambda e: received.append(e), filter_func=important_only)
...
class TestIntegrationBusReview:
    def test_wildcard_subscriptions(self, integration_bus):
        ...
        integration_bus.subscribe("system.*", lambda e: received.append(e))
    ...
    def test_handler_exceptions(self, integration_bus):
        ...
        integration_bus.subscribe("test", lambda e: received.append(e))
...
class TestEventEmitterEventListenerReview:
    def test_listener_once(self, event_bus):
        ...
        listener.once(EventType.SYSTEM_STARTUP, lambda e: received.append(e))
