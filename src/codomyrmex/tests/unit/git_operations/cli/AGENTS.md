# Git Operations / CLI Tests -- Agent Coordination

**Version**: v1.0.8 | **Status**: Active | **Last Updated**: March 2026

## Overview

Test suite for the `git_operations/cli` module, implementing the zero-mock testing policy.
...
1. Run this test suite after any changes to `src/codomyrmex/git_operations/`
...
- [README.md](README.md) | [SPEC.md](SPEC.md) | [Source](../../../../../git_operations/)
