# Soul Test Specification

**Version**: v1.1.9 | **Status**: Active | **Last Updated**: March 2026

## Overview

Specification for the `soul` test suite.
...
1. All public API methods in `soul` must have at least one test
...
**Requires**: `pytest`, `uv sync --extra soul` (if module has optional deps)
