# Quantization Test Specification

**Version**: v1.1.0 | **Status**: Active | **Last Updated**: March 2026

## Overview

Specification for the `quantization` test suite.
...
1. All public API methods in `quantization` must have at least one test
...
**Requires**: `pytest`, `uv sync --extra quantization` (if module has optional deps)
