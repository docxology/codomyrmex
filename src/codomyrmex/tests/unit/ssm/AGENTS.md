# SSM (State Space Model) Tests -- Agent Coordination

**Version**: v1.1.0 | **Status**: Active | **Last Updated**: March 2026

## Overview

Test suite for the `ssm` module, implementing the zero-mock testing policy.
...
1. Run this test suite after any changes to `src/codomyrmex/ssm/`
...
- [README.md](README.md) | [SPEC.md](SPEC.md) | [Source](../../../../ssm/)
