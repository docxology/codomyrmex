# Operating System Test Specification

**Version**: v1.1.9 | **Status**: Active | **Last Updated**: March 2026

## Overview

Specification for the `operating_system` test suite.
...
1. All public API methods in `operating_system` must have at least one test
...
**Requires**: `pytest`, `uv sync --extra operating_system` (if module has optional deps)
