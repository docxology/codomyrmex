...
class TestStoreMemory:
    ...
    def test_store_basic(self, _patch_db: Path) -> None:
    ...
    def test_store_truncates_long_content(self, _patch_db: Path) -> None:
    ...
    def test_store_with_metadata(self, _patch_db: Path) -> None:
...
class TestConsolidateMemories:
    ...
    def test_no_duplicates(self, _patch_db: Path, tmp_db: Path) -> None:
...
class TestGetMemoryStats:
    ...
    def test_returns_not_installed_when_db_missing(
        self, tmp_path: Path, monkeypatch: pytest.MonkeyPatch
    ) -> None:
