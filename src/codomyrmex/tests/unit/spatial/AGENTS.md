# Codomyrmex Agents — src/codomyrmex/tests/unit/spatial

**Version**: v0.1.0 | **Status**: Active | **Last Updated**: March 2026

## Purpose
Validation coverage, fixtures, and regression checks for Spatial.
...
- `test_mcp_tools_spatial.py` – Project file
- `test_spatial.py` – Project file
