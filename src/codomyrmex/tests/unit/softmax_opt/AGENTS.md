# Softmax Optimization Tests -- Agent Coordination

**Version**: v1.1.4 | **Status**: Active | **Last Updated**: March 2026

## Overview

Test suite for the `softmax_opt` module, implementing the zero-mock testing policy.
...
1. Run this test suite after any changes to `src/codomyrmex/softmax_opt/`
...
- [README.md](README.md) | [SPEC.md](SPEC.md) | [Source](../../../../softmax_opt/)
