# SLM (Small Language Model) Test Specification

**Version**: v1.1.0 | **Status**: Active | **Last Updated**: March 2026

## Overview

Specification for the `slm` test suite.
...
1. All public API methods in `slm` must have at least one test
...
**Requires**: `pytest`, `uv sync --extra slm` (if module has optional deps)
