...
class TestDataLineageImports:
    ...
    def test_module_imports(self):
        ...
        from codomyrmex.database_management import lineage as data_lineage
        assert data_lineage is not None

    def test_public_api_exists(self):
        """Verify expected public API is available."""
        from codomyrmex.database_management.lineage import __all__
        expected_exports = [
            "NodeType",
            "EdgeType",
            "LineageNode",
...
class TestNodeType:
    ...
    def test_node_type_values(self):
        ...
        from codomyrmex.database_management.lineage import NodeType
...
class TestEdgeType:
    ...
    def test_edge_type_values(self):
        ...
        from codomyrmex.database_management.lineage import EdgeType
...
class TestLineageNode:
    ...
    def test_node_creation(self):
        ...
        from codomyrmex.database_management.lineage import LineageNode, NodeType
...
class TestLineageEdge:
    ...
    def test_edge_creation(self):
        ...
        from codomyrmex.database_management.lineage import EdgeType, LineageEdge
...
class TestDataAsset:
    ...
    def test_data_asset_creation(self):
        ...
        from codomyrmex.database_management.lineage import DataAsset
...
class TestLineageTracker:
    ...
    def test_tracker_register_dataset(self):
        ...
        from codomyrmex.database_management.lineage import LineageTracker, NodeType
