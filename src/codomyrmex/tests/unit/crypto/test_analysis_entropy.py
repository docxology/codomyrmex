...
class TestShannonEntropy:
    ...
    def test_four_equally_likely_symbols(self):
        """Verify four equally likely symbols behavior."""
...
class TestByteEntropy:
    ...
    def test_single_value_returns_zero(self):
        """Verify single value returns zero behavior."""
        assert byte_entropy(bytes([42]) * 1000) == 0.0

    def test_uniform_random_near_eight(self):
        """Verify uniform random near eight behavior."""
...
class TestChiSquaredTest:
    ...
    def test_empty_data_raises(self):
        """Verify empty data raises behavior."""
        with pytest.raises(ValueError):
            chi_squared_test(b"")

    def test_uniform_data_passes(self):
        """Verify uniform data passes behavior."""
    ...
    def test_biased_data_fails(self):
        """Verify biased data fails behavior."""
    ...
    def test_random_bytes_likely_passes(self):
        """Verify random bytes likely passes behavior."""
    ...
    def test_result_dataclass_fields(self):
        """Verify result dataclass fields behavior."""
...
class TestSerialCorrelation:
    ...
    def test_constant_bytes_returns_zero(self):
        """Verify constant bytes returns zero behavior."""
    ...
    def test_sequential_bytes_positive_correlation(self):
        """Verify sequential bytes positive correlation behavior."""
    ...
    def test_alternating_bytes_negative_correlation(self):
        """Verify alternating bytes negative correlation behavior."""
    ...
    def test_range_is_bounded(self):
        """Verify range is bounded behavior."""
