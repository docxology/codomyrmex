...
class TestBase64:
    ...
    def test_binary_data(self) -> None:
        """Verify binary data behavior."""
        data = bytes(range(256))
        assert decode_base64(encode_base64(data)) == data

    def test_known_vector(self) -> None:
        """Verify known vector behavior."""
    ...
    def test_decode_invalid_raises(self) -> None:
        """Verify decode invalid raises behavior."""
...
class TestHex:
    ...
    def test_decode_uppercase(self) -> None:
        """Verify decode uppercase behavior."""
    ...
    def test_is_valid_hex_true(self) -> None:
        """Verify is valid hex true behavior."""
    ...
    def test_is_valid_hex_false(self) -> None:
        """Verify is valid hex false behavior."""
...
class TestPEM:
    ...
    def test_decode_no_markers_raises(self) -> None:
        """Verify decode no markers raises behavior."""
    ...
    def test_identify_no_header_raises(self) -> None:
        """Verify identify no header raises behavior."""
