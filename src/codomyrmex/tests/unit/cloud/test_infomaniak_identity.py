...
class TestInfomaniakIdentity:
    ...
    def stub_openstack_connection(self):
        """Create a stub OpenStack connection with standard IDs."""
        conn = Stub()
    ...
    def _make_client(self, conn):
        """Helper to create an InfomaniakIdentityClient from a stub connection."""
    ...
    def test_get_current_user_success(self, stub_openstack_connection):
        """get_current_user returns dict with id, name, email, domain_id, is_enabled."""
        stub_user = Stub()
        stub_user.id = "user-test-123"
        stub_user.name = "alice"
        stub_user.email = "alice@infomaniak.cloud"
        stub_user.domain_id = "domain-abc"
        stub_user.is_enabled = True

        stub_openstack_connection.identity.get_user.return_value = stub_user

        client = self._make_client(stub_openstack_connection)
        ...
        stub_openstack_connection.identity.get_user.assert_called_once_with(
            "user-test-123"
        )

    def test_get_current_user_error_returns_empty_dict(self, stub_openstack_connection):
        """get_current_user returns {} on exception."""
        stub_openstack_connection.identity.get_user.side_effect = Exception(
            "auth failure"
        )
    ...
    def test_get_user_success(self, stub_openstack_connection):
        """get_user returns user dict for a specific user ID."""
        stub_user = Stub()
        stub_user.id = "user-other-789"
        stub_user.name = "bob"
        stub_user.email = "bob@example.com"
        stub_user.domain_id = "domain-xyz"
    ...
    def test_get_user_error_returns_none(self, stub_openstack_connection):
        """get_user returns None on exception."""
        stub_openstack_connection.identity.get_user.side_effect = Exception("not found")
    ...
    def test_list_projects_success(self, stub_openstack_connection):
        """list_projects returns list of project dicts."""
        stub_proj1 = Stub()
        stub_proj1.id = "proj-1"
        stub_proj1.name = "alpha"
        stub_proj1.description = "Alpha project"
        stub_proj1.is_enabled = True
        stub_proj1.domain_id = "domain-abc"

        stub_proj2 = Stub()
        stub_proj2.id = "proj-2"
        stub_proj2.name = "beta"
        stub_proj2.description = "Beta project"
        stub_proj2.is_enabled = False
        stub_proj2.domain_id = "domain-abc"

        stub_openstack_connection.identity.projects.return_value = [
            stub_proj1,
            stub_proj2,
        ]
    ...
    def test_list_projects_error_returns_empty_list(self, stub_openstack_connection):
        """list_projects returns [] on exception."""
        stub_openstack_connection.identity.projects.side_effect = Exception("forbidden")
    ...
    def test_get_current_project_success(self, stub_openstack_connection):
        """get_current_project returns dict with id, name, description."""
        stub_project = Stub()
        stub_project.id = "proj-test-456"
        stub_project.name = "main-project"
        stub_project.description = "The main project"

        stub_openstack_connection.identity.get_project.return_value = stub_project
        ...
        stub_openstack_connection.identity.get_project.assert_called_once_with(
            "proj-test-456"
        )
    ...
    def test_get_current_project_error_returns_empty_dict(
        ...
        stub_openstack_connection.identity.get_project.side_effect = Exception(
            "timeout"
        )
    ...
    def test_list_application_credentials_success(self, stub_openstack_connection):
        """list_application_credentials returns credential dicts with role names."""
        stub_cred = Stub()
        stub_cred.id = "appcred-001"
        stub_cred.name = "ci-deploy"
        stub_cred.description = "For CI/CD pipelines"
        stub_cred.expires_at = "2026-12-31T23:59:59Z"
        stub_cred.roles = [{"name": "member"}, {"name": "reader"}]

        stub_openstack_connection.identity.application_credentials.return_value = [
            stub_cred
        ]
        ...
        stub_openstack_connection.identity.application_credentials.assert_called_once_with(
            user="user-test-123"
        )
    ...
    def test_list_application_credentials_error_returns_empty_list(
        ...
        stub_openstack_connection.identity.application_credentials.side_effect = (
            Exception("denied")
        )
    ...
    def test_create_application_credential_success(self, stub_openstack_connection):
        """create_application_credential returns dict with id, name, secret, expires_at."""
        stub_cred = Stub()
        stub_cred.id = "appcred-new"
        stub_cred.name = "terraform-cred"
        stub_cred.secret = "super-secret-value-only-shown-once"
        stub_cred.expires_at = None

        stub_openstack_connection.identity.create_application_credential.return_value = stub_cred
        ...
        stub_openstack_connection.identity.create_application_credential.assert_called_once_with(
            user="user-test-123",
            name="terraform-cred",
            description="For Terraform",
            expires_at=None,
    ...
    def test_create_application_credential_error_returns_none(
        ...
        stub_openstack_connection.identity.create_application_credential.side_effect = (
    ...
    def test_get_application_credential_success(self, stub_openstack_connection):
        """get_application_credential returns credential dict by ID."""
        stub_cred = Stub()
        stub_cred.id = "appcred-fetch"
        stub_cred.name = "fetched-cred"
        stub_cred.description = "Some description"
        stub_cred.expires_at = "2027-06-01T00:00:00Z"

        stub_openstack_connection.identity.get_application_credential.return_value = (
            stub_cred
        )
        ...
        stub_openstack_connection.identity.get_application_credential.assert_called_once_with(
            user="user-test-123",
    ...
    def test_get_application_credential_error_returns_none(
        ...
        stub_openstack_connection.identity.get_application_credential.side_effect = (
            Exception("not found")
        )
    ...
    def test_delete_application_credential_success(self, stub_openstack_connection):
        """delete_application_credential returns True on success."""
        client = self._make_client(stub_openstack_connection)
        result = client.delete_application_credential("appcred-del")

        assert result is True
        stub_openstack_connection.identity.delete_application_credential.assert_called_once_with(
            user="user-test-123",
    ...
    def test_delete_application_credential_error_returns_false(
        ...
        stub_openstack_connection.identity.delete_application_credential.side_effect = (
            Exception("forbidden")
        )
    ...
    def test_list_roles_success(self, stub_openstack_connection):
        """list_roles returns list of role dicts with id, name, description."""
        stub_role1 = Stub()
        stub_role1.id = "role-admin"
        stub_role1.name = "admin"
        stub_role1.description = "Administrator role"

        stub_role2 = Stub()
        stub_role2.id = "role-member"
        stub_role2.name = "member"
        stub_role2.description = "Member role"

        stub_openstack_connection.identity.roles.return_value = [stub_role1, stub_role2]
    ...
    def test_list_roles_error_returns_empty_list(self, stub_openstack_connection):
        """list_roles returns [] on exception."""
        stub_openstack_connection.identity.roles.side_effect = Exception(
            "service unavailable"
        )
    ...
    def test_list_user_roles_success(self, stub_openstack_connection):
        """list_user_roles resolves role assignments to role dicts."""
        stub_ra1 = Stub()
        stub_ra1.role = {"id": "role-1"}
        stub_ra2 = Stub()
        stub_ra2.role = {"id": "role-2"}

        stub_openstack_connection.identity.role_assignments.return_value = [
            stub_ra1,
            stub_ra2,
        ]

        stub_resolved_role1 = Stub()
        stub_resolved_role1.id = "role-1"
        stub_resolved_role1.name = "member"

        stub_resolved_role2 = Stub()
        stub_resolved_role2.id = "role-2"
        stub_resolved_role2.name = "reader"

        stub_openstack_connection.identity.get_role.side_effect = [
            stub_resolved_role1,
            stub_resolved_role2,
        ]
        ...
        stub_openstack_connection.identity.role_assignments.assert_called_once_with(
            user="user-test-123",
            project="proj-test-456",
        )

    def test_list_user_roles_with_explicit_project(self, stub_openstack_connection):
    ...
    def test_list_user_roles_error_returns_empty_list(self, stub_openstack_connection):
        """list_user_roles returns [] on exception."""
        stub_openstack_connection.identity.role_assignments.side_effect = Exception(
            "timeout"
        )
    ...
    def test_list_ec2_credentials_filters_by_type(self, stub_openstack_connection):
        """list_ec2_credentials only returns credentials with type=='ec2'."""
        stub_ec2_cred = Stub()
        stub_ec2_cred.id = "cred-ec2"
        stub_ec2_cred.type = "ec2"
        stub_ec2_cred.access = "AKIA-EXAMPLE"
        stub_ec2_cred.project_id = "proj-test-456"

        stub_other_cred = Stub()
        stub_other_cred.id = "cred-other"
        stub_other_cred.type = "cert"
        stub_other_cred.access = "CERT-EXAMPLE"
        stub_other_cred.project_id = "proj-test-456"

        stub_openstack_connection.identity.credentials.return_value = [
            stub_ec2_cred,
            stub_other_cred,
        ]
        ...
        stub_openstack_connection.identity.credentials.assert_called_once_with(
    ...
    def test_list_ec2_credentials_error_returns_empty_list(
        ...
        stub_openstack_connection.identity.credentials.side_effect = Exception(
            "connection error"
        )
    ...
    def test_create_ec2_credentials_success(self, stub_openstack_connection):
        """create_ec2_credentials returns dict with id, access, secret, project_id."""
        stub_cred = Stub()
        stub_cred.id = "ec2-new"
        stub_cred.access = "AKIA-NEW"
        stub_cred.secret = "SECRET-NEW-VALUE"
        stub_cred.project_id = "proj-test-456"

        stub_openstack_connection.identity.create_credential.return_value = stub_cred
        ...
        stub_openstack_connection.identity.create_credential.assert_called_once_with(
            user_id="user-test-123",
            type="ec2",
    ...
    def test_create_ec2_credentials_with_explicit_project(
        ...
        stub_cred = Stub()
        stub_cred.id = "ec2-custom"
        stub_cred.access = "AKIA-CUSTOM"
        stub_cred.secret = "SECRET-CUSTOM"
        stub_cred.project_id = "proj-other-789"
    ...
    def test_create_ec2_credentials_error_returns_none(self, stub_openstack_connection):
        """create_ec2_credentials returns None on exception."""
        stub_openstack_connection.identity.create_credential.side_effect = Exception(
            "quota exceeded"
        )
    ...
    def test_delete_ec2_credentials_success(self, stub_openstack_connection):
        """delete_ec2_credentials returns True on success."""
        client = self._make_client(stub_openstack_connection)
        result = client.delete_ec2_credentials("ec2-del")

        assert result is True
        stub_openstack_connection.identity.delete_credential.assert_called_once_with(
            "ec2-del"
        )
    ...
    def test_delete_ec2_credentials_error_returns_false(
        ...
        stub_openstack_connection.identity.delete_credential.side_effect = Exception(
            "not found"
        )
...
class TestInfomaniakIdentityClientExpanded:
    ...
    def _make_client(self):
        ...
        stub_conn = Stub()
        stub_conn.current_user_id = "uid-1"
        stub_conn.current_project_id = "proj-1"
        return InfomaniakIdentityClient(connection=stub_conn), stub_conn
