# Agents / Claude Mixins Tests -- Agent Coordination

**Version**: v1.1.9 | **Status**: Active | **Last Updated**: March 2026

## Overview

Test suite for the `agents/claude` module, implementing the zero-mock testing policy.
...
1. Run this test suite after any changes to `src/codomyrmex/agents/claude/`
...
- [README.md](README.md) | [SPEC.md](SPEC.md) | [Source](../../../../../agents/claude/)
