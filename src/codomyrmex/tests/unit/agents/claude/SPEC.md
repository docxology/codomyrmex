# Agents / Claude Mixins Test Specification

**Version**: v1.1.9 | **Status**: Active | **Last Updated**: March 2026

## Overview

Specification for the `agents/claude` test suite.
...
1. All public API methods in `agents/claude` must have at least one test
