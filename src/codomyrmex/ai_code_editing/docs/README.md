# src/codomyrmex/ai_code_editing/docs

**Version**: v0.1.0 | **Status**: Active | **Last Updated**: October 2025

## Overview

Container for the `src/codomyrmex/ai_code_editing/docs` agent surfaces and supporting assets.
...
from codomyrmex.src.codomyrmex.ai_code_editing.docs import ModuleClass
