...
def generate_code_snippet(
    ...
    **kwargs
    ...
    try:
        ...
        logger.info(f"Generated {language} code snippet using {provider}/{model} in {execution_time:.2f}s")
        return result
...
def refactor_code_snippet(
    ...
    **kwargs
    ...
    try:
        ...
        # Prepare the prompt
        functionality_note = "Preserve the original functionality exactly." if preserve_functionality else "You may modify functionality if it improves the code."
...
{functionality_note}"""
        ...
        logger.info(f"Refactored {language} code using {provider}/{model} in {execution_time:.2f}s")
        return result
...
def analyze_code_quality(
    ...
    **kwargs
    ...
    try:
        ...
        logger.info(f"Analyzed {language} code using {provider}/{model} in {execution_time:.2f}s")
        return result
...
{context if context else ""}"""
        ...
        logger.info(f"Compared {language} code versions using {provider}/{model} in {execution_time:.2f}s")
        return result
...
def generate_code_documentation(
    ...
    **kwargs
    ...
    try:
        ...
        logger.info(f"Generated {doc_type} documentation for {language} code using {provider}/{model} in {execution_time:.2f}s")
        return result
