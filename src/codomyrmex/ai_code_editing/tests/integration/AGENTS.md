# Codomyrmex Agents — src/codomyrmex/ai_code_editing/tests/integration

## Purpose
Integration tests for ai code editing workflows, validating end-to-end workflows and cross-component interactions with realistic test scenarios.
...
- Integration tests validate AI code editing workflows across multiple components.
- Test execution maintains realistic scenarios and comprehensive workflow coverage.

## Related Modules
- **AI Code Editing Tests** (`../`) - Parent test directory
