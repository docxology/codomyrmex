...
### Internal Coherence
- **Unified Prompting**: Centralized prompt templates (`prompt_templates/`) ensure consistent persona and output format.
...
- **Integration Tests**: Tested against `ollama_integration` for local validation.
...
- **Safety**: No execution of generated code within this module (delegated to `code_execution_sandbox`).
...
### Dependencies
- `codomyrmex.language_models`: For raw text generation.
