...
CATEGORY_GROUP_MAP: dict[str, str] = {
    ...
    "codex": "CodomyrmexCodex",
    "deepseek": "CodomyrmexDeepseek",
    "every_code": "CodomyrmexEveryCode",
    "gemini": "CodomyrmexGemini",
    "hermes": "CodomyrmexHermes",
    "llm": "CodomyrmexAI",
    "mistral_vibe": "CodomyrmexMistralVibe",
    "o1": "CodomyrmexO1",
    "openclaw": "CodomyrmexOpenclaw",
    "openfang": "CodomyrmexOpenfang",
    "orchestrator": "CodomyrmexAI",
    "paperclip": "CodomyrmexPaperclip",
    "pi": "CodomyrmexPi",
...
SKILL_DESCRIPTIONS: dict[str, str] = {
    ...
    "Codomyrmex": (
        "Full-spectrum coding workspace skill providing 623 production MCP @mcp_tool lines "
        "across 130 top-level modules; the current merged runtime manifest exposes 608 "
        "tools (see docs/reference/inventory.md). "
