...
- **Path**: `src/codomyrmex/skills/skills/custom/geopolitical_market_sim`
...
- Python source `geopolitical_market_pipeline.py`
- Config/data `skill.yaml`
...
## Navigation Links
- **Parent directory**: [custom](../README.md) — parent folder overview
