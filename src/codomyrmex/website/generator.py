...
class WebsiteGenerator:
    ...
    def generate(self) -> None:
        ...
        # 3. Render Pages
        pages = ["index.html", "health.html", "modules.html", "tools.html", "scripts.html", "chat.html", "agents.html", "config.html", "docs.html", "pipelines.html", "awareness.html", "pai_control.html", "dispatch.html"]
        for page in pages:
            try:
