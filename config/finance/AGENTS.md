# Finance -- Configuration Agent Coordination

**Version**: v1.1.4 | **Status**: Active | **Last Updated**: March 2026

## Overview

Agent coordination guide for configuring and using the finance module. Financial calculations, portfolio management, and market data analysis.

## Configuration Requirements

Before using finance in any PAI workflow, ensure:

1. The module is importable via `from codomyrmex.finance import *`
2. Any optional dependencies are installed (check with `codomyrmex check`)

## Agent Instructions

1. Import the module directly: `from codomyrmex.finance import ...`
...
4. Financial model parameters (interest rates, risk factors) are set per-calculation. No global financial configuration.
...
value = get_config("finance.setting")

# Update configuration
set_config("finance.setting", "new_value")
```
...
- [README.md](README.md) | [SPEC.md](SPEC.md) | [Source Module](../../src/codomyrmex/finance/AGENTS.md)
