# Graph RAG -- Configuration Agent Coordination

**Version**: v1.1.0 | **Status**: Active | **Last Updated**: March 2026

## Overview

Agent coordination guide for configuring and using the graph_rag module. Graph-based Retrieval Augmented Generation combining knowledge graphs with LLM retrieval for enhanced question answering and knowledge exploration.

## Configuration Requirements

Before using graph_rag in any PAI workflow, ensure:

1. The module is importable via `from codomyrmex.graph_rag import *`
2. Any optional dependencies are installed (check with `codomyrmex check`)

## Agent Instructions

1. Import the module directly: `from codomyrmex.graph_rag import ...`
...
4. Graph storage and retrieval parameters are configured per-instance. Embedding model and similarity threshold are adjustable.
...
value = get_config("graph_rag.setting")

# Update configuration
set_config("graph_rag.setting", "new_value")
```
...
- [README.md](README.md) | [SPEC.md](SPEC.md) | [Source Module](../../src/codomyrmex/graph_rag/AGENTS.md)
