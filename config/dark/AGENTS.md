# Dark -- Configuration Agent Coordination

**Version**: v1.1.0 | **Status**: Active | **Last Updated**: March 2026

## Overview

Agent coordination guide for configuring and using the dark module. PDF dark mode utilities providing inversion, brightness, contrast, and sepia filters for PDF documents.

## Configuration Requirements

Before using dark in any PAI workflow, ensure:

1. The module is importable via `from codomyrmex.dark import *`
2. Any optional dependencies are installed (check with `codomyrmex check`)

## Agent Instructions

1. Import the module directly: `from codomyrmex.dark import ...`
...
4. Requires optional dependencies: `uv sync --extra dark`. Filter parameters (inversion level, brightness, contrast) are set per-document.
...
value = get_config("dark.setting")

# Update configuration
set_config("dark.setting", "new_value")
```
...
- [README.md](README.md) | [SPEC.md](SPEC.md) | [Source Module](../../src/codomyrmex/dark/AGENTS.md)
