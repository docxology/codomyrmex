# Video -- Configuration Agent Coordination

**Version**: v1.1.4 | **Status**: Active | **Last Updated**: March 2026

## Overview

Agent coordination guide for configuring and using the video module. Video processing including capture, editing, transcoding, and analysis.

## Configuration Requirements

Before using video in any PAI workflow, ensure:

1. The module is importable via `from codomyrmex.video import *`
2. Any optional dependencies are installed (check with `codomyrmex check`)

## Agent Instructions

1. Import the module directly: `from codomyrmex.video import ...`
...
4. Requires optional dependencies: `uv sync --extra video`. FFmpeg must be installed for transcoding operations.
...
value = get_config("video.setting")

# Update configuration
set_config("video.setting", "new_value")
```
...
- [README.md](README.md) | [SPEC.md](SPEC.md) | [Source Module](../../src/codomyrmex/video/AGENTS.md)
