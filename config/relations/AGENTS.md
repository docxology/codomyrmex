# Relations -- Configuration Agent Coordination

**Version**: v1.1.9 | **Status**: Active | **Last Updated**: March 2026

## Overview

Agent coordination guide for configuring and using the relations module. Relationship strength scoring between entities.

## Configuration Requirements

Before using relations in any PAI workflow, ensure:

1. The module is importable via `from codomyrmex.relations import *`
2. Any optional dependencies are installed (check with `codomyrmex check`)

## Agent Instructions

1. Import the module directly: `from codomyrmex.relations import ...`
2. Check module availability with `list_modules()` from system_discovery
3. Available MCP tools: `relations_score_strength`
4. Scoring model parameters and relationship type weights are configurable. Default scoring uses a weighted sum model.
...
value = get_config("relations.setting")

# Update configuration
set_config("relations.setting", "new_value")
```
...
- [README.md](README.md) | [SPEC.md](SPEC.md) | [Source Module](../../src/codomyrmex/relations/AGENTS.md)
