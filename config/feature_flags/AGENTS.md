# Feature Flags -- Configuration Agent Coordination

**Version**: v1.1.0 | **Status**: Active | **Last Updated**: March 2026

## Overview

Agent coordination guide for configuring and using the feature_flags module. Feature flag management with percentage-based, user-list, and time-window strategies.

## Configuration Requirements

Before using feature_flags in any PAI workflow, ensure:

1. The module is importable via `from codomyrmex.feature_flags import *`
2. Any optional dependencies are installed (check with `codomyrmex check`)

## Agent Instructions

1. Import the module directly: `from codomyrmex.feature_flags import ...`
...
4. Feature flags are defined programmatically with strategy objects (PercentageStrategy, UserListStrategy, TimeWindowStrategy). Flags can be toggled at runtime.
...
value = get_config("feature_flags.setting")

# Update configuration
set_config("feature_flags.setting", "new_value")
```
...
- [README.md](README.md) | [SPEC.md](SPEC.md) | [Source Module](../../src/codomyrmex/feature_flags/AGENTS.md)
