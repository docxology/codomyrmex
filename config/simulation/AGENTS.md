# Simulation -- Configuration Agent Coordination

**Version**: v1.1.4 | **Status**: Active | **Last Updated**: March 2026

## Overview

Agent coordination guide for configuring and using the simulation module. Discrete event simulation and agent-based modeling.

## Configuration Requirements

Before using simulation in any PAI workflow, ensure:

1. The module is importable via `from codomyrmex.simulation import *`
2. Any optional dependencies are installed (check with `codomyrmex check`)

## Agent Instructions

1. Import the module directly: `from codomyrmex.simulation import ...`
...
4. Simulation parameters (time step, duration, random seed) are set per-simulation run. Event schedulers support priority queues.
...
value = get_config("simulation.setting")

# Update configuration
set_config("simulation.setting", "new_value")
```
...
- [README.md](README.md) | [SPEC.md](SPEC.md) | [Source Module](../../src/codomyrmex/simulation/AGENTS.md)
