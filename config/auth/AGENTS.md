# Auth -- Configuration Agent Coordination

**Version**: v1.1.0 | **Status**: Active | **Last Updated**: March 2026

## Overview

Agent coordination guide for configuring and using the auth module. Authentication and authorization with API key management, OAuth integration, and Role-Based Access Control (RBAC).

## Configuration Requirements

Before using auth in any PAI workflow, ensure:

1. The module is importable via `from codomyrmex.auth import *`
2. Any optional dependencies are installed (check with `codomyrmex check`)

## Agent Instructions

1. Import the module directly: `from codomyrmex.auth import ...`
...
4. Token expiration and RBAC permissions are configured programmatically through the Authenticator and PermissionRegistry classes.
...
value = get_config("auth.setting")

# Update configuration
set_config("auth.setting", "new_value")
```
...
- [README.md](README.md) | [SPEC.md](SPEC.md) | [Source Module](../../src/codomyrmex/auth/AGENTS.md)
