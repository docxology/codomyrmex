# Logistics -- Configuration Agent Coordination

**Version**: v1.1.4 | **Status**: Active | **Last Updated**: March 2026

## Overview

Agent coordination guide for configuring and using the logistics module. Task orchestration, project management, and workflow logistics.

## Configuration Requirements

Before using logistics in any PAI workflow, ensure:

1. The module is importable via `from codomyrmex.logistics import *`
2. Any optional dependencies are installed (check with `codomyrmex check`)

## Agent Instructions

1. Import the module directly: `from codomyrmex.logistics import ...`
...
4. Logistics uses a class-based MCP pattern (not auto-discovered via @mcp_tool). Task scheduling and project configuration are set programmatically.
...
value = get_config("logistics.setting")

# Update configuration
set_config("logistics.setting", "new_value")
```
...
- [README.md](README.md) | [SPEC.md](SPEC.md) | [Source Module](../../src/codomyrmex/logistics/AGENTS.md)
