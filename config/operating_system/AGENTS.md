# Operating System -- Configuration Agent Coordination

**Version**: v1.1.0 | **Status**: Active | **Last Updated**: March 2026

## Overview

Agent coordination guide for configuring and using the operating_system module. OS-level utilities for Linux, macOS, and Windows.

## Configuration Requirements

Before using operating_system in any PAI workflow, ensure:

1. The module is importable via `from codomyrmex.operating_system import *`
2. Any optional dependencies are installed (check with `codomyrmex check`)

## Agent Instructions

1. Import the module directly: `from codomyrmex.operating_system import ...`
...
4. Platform detection is automatic. OS-specific modules load conditionally based on the detected operating system.
...
value = get_config("operating_system.setting")

# Update configuration
set_config("operating_system.setting", "new_value")
```
...
- [README.md](README.md) | [SPEC.md](SPEC.md) | [Source Module](../../src/codomyrmex/operating_system/AGENTS.md)
