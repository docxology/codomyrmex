# Wallet -- Configuration Agent Coordination

**Version**: v1.1.4 | **Status**: Active | **Last Updated**: March 2026

## Overview

Agent coordination guide for configuring and using the wallet module. Digital wallet management for cryptocurrency and token operations.

## Configuration Requirements

Before using wallet in any PAI workflow, ensure:

1. The module is importable via `from codomyrmex.wallet import *`
2. Any optional dependencies are installed (check with `codomyrmex check`)

## Agent Instructions

1. Import the module directly: `from codomyrmex.wallet import ...`
...
4. Wallet encryption keys and network endpoints are configured per-wallet instance. Private key storage uses encrypted containers.
...
value = get_config("wallet.setting")

# Update configuration
set_config("wallet.setting", "new_value")
```
...
- [README.md](README.md) | [SPEC.md](SPEC.md) | [Source Module](../../src/codomyrmex/wallet/AGENTS.md)
