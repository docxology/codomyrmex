# FPF -- Configuration Agent Coordination

**Version**: v1.1.4 | **Status**: Active | **Last Updated**: March 2026

## Overview

Agent coordination guide for configuring and using the fpf module. Fetch-Parse-Format pipeline for extracting, parsing, and exporting content from URLs.

## Configuration Requirements

Before using fpf in any PAI workflow, ensure:

1. The module is importable via `from codomyrmex.fpf import *`
2. Any optional dependencies are installed (check with `codomyrmex check`)

## Agent Instructions

1. Import the module directly: `from codomyrmex.fpf import ...`
...
4. URL fetching uses configurable timeout and retry settings. Output format (JSON, Markdown, plain text) is selected per-operation.
...
value = get_config("fpf.setting")

# Update configuration
set_config("fpf.setting", "new_value")
```
...
- [README.md](README.md) | [SPEC.md](SPEC.md) | [Source Module](../../src/codomyrmex/fpf/AGENTS.md)
