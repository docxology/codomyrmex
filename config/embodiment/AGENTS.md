# Embodiment -- Configuration Agent Coordination

**Version**: v1.1.4 | **Status**: Active | **Last Updated**: March 2026

## Overview

Agent coordination guide for configuring and using the embodiment module. Robotics integration with ROS2, sensors, actuators, and 3D transforms.

## Configuration Requirements

Before using embodiment in any PAI workflow, ensure:

1. The module is importable via `from codomyrmex.embodiment import *`
2. Any optional dependencies are installed (check with `codomyrmex check`)

## Agent Instructions

1. Import the module directly: `from codomyrmex.embodiment import ...`
...
4. ROS2 integration requires ROS2 installed and sourced. Transform3D operates independently without external configuration.
...
value = get_config("embodiment.setting")

# Update configuration
set_config("embodiment.setting", "new_value")
```
...
- [README.md](README.md) | [SPEC.md](SPEC.md) | [Source Module](../../src/codomyrmex/embodiment/AGENTS.md)
