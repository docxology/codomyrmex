# Static Analysis -- Configuration Agent Coordination

**Version**: v1.1.0 | **Status**: Active | **Last Updated**: March 2026

## Overview

Agent coordination guide for configuring and using the static_analysis module. Code quality analysis, linting, and security scanning.

## Configuration Requirements

Before using static_analysis in any PAI workflow, ensure:

1. The module is importable via `from codomyrmex.static_analysis import *`
2. Any optional dependencies are installed (check with `codomyrmex check`)

## Agent Instructions

1. Import the module directly: `from codomyrmex.static_analysis import ...`
...
4. Analysis rules and severity thresholds are configurable. Linting integrates with ruff and black for formatting checks.
...
value = get_config("static_analysis.setting")

# Update configuration
set_config("static_analysis.setting", "new_value")
```
...
- [README.md](README.md) | [SPEC.md](SPEC.md) | [Source Module](../../src/codomyrmex/static_analysis/AGENTS.md)
