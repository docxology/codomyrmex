...
| Tests collected | 21,000+ | **34,492** at v1.2.3 snapshot; **39,473** current ([inventory](docs/reference/inventory.md)) |
...
Live module and MCP counts: [docs/reference/inventory.md](docs/reference/inventory.md).
