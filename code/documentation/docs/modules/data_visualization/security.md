...
title: 'Data Visualization - Security Policy'
---

# Security Policy for Data Visualization

This document outlines security procedures and policies for the Data Visualization module.
...
This security policy applies only to the `Data Visualization` module within the Codomyrmex project. For project-wide security concerns, please refer to the main project's security policy (if available) or contact the core project maintainers.
