...
| `.github/README.md` | yes | N/A | — | Manual twin of root README; stats match `README.md` + [inventory.md](../reference/inventory.md) (34,334 tests, 1,164 `docs/*.md`, 37 workflows) |
...
| `README.md`, `.github/README.md`, `docs/README.md`, `docs/index.md`, agent SPEC/PAI/core, getting-started | yes | N/A | — | 2026-05-13: **39** agent packages + **34,334** tests + **37** workflows + **1,164** `docs/*.md`; hub tables aligned with `find` |
| _(add rows)_    |               |               |      |         |
