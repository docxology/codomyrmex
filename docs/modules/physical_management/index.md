...
- [API Specification](../../../src/codomyrmex/physical_management/API_SPECIFICATION.md) (Link to the main API spec)
...
- Refer to the [API Reference](./API_REFERENCE.md) and [API Specification](../../../src/codomyrmex/physical_management/API_SPECIFICATION.md) for details on how to interact with the module programmatically.
- Explore the [Examples](../../../scripts/physical_management/examples) directory for usage examples.

## Related Documentation

- [Module README](../README.md)
- [Security Considerations](../../../src/codomyrmex/physical_management/SECURITY.md)
