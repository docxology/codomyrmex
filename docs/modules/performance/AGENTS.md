...
Documentation stub for the `performance` module. Primary documentation resides in the source module.
...
- [src/codomyrmex/performance/AGENTS.md](../../../src/codomyrmex/performance/AGENTS.md)
