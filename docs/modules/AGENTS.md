...
Comprehensive documentation hub for all 94 Codomyrmex modules. Provides API specifications, usage guides, tutorials, and integration patterns for every module in the system.
...
- 94 module subdirectories (see Module Categories below)
...
All 94 modules have the full RASP set: README.md + AGENTS.md + SPEC.md.

## Agent Quality Standards

1. **Documentation Completeness**: Each module docs folder has README.md, AGENTS.md, SPEC.md (94/94 complete)
