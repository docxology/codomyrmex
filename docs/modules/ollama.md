...
python -m pytest tests/unit/test_ollama_integration.py::TestOllamaIntegration -v
python -m pytest tests/unit/test_ollama_integration.py::TestOllamaIntegrationRealExecution -v
```
