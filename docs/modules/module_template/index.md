...
Welcome to the detailed documentation for the [Module Name] module.
...
- [API Specification](../../../src/codomyrmex/module_template/API_SPECIFICATION.md) (Link to the main API spec)
- [Usage Examples](../../../src/codomyrmex/module_template/USAGE_EXAMPLES.md) (Link to usage examples)
- [Tutorials](./tutorials/)
