...
Mirror of [src/codomyrmex/utils/PAI.md](../../../src/codomyrmex/utils/PAI.md); edit the source file first, then align this copy.
...
Exposed via `mcp_tools.py` in the source tree; see [MCP_TOOL_SPECIFICATION.md](MCP_TOOL_SPECIFICATION.md).
...
- **Source PAI**: [../../../src/codomyrmex/utils/PAI.md](../../../src/codomyrmex/utils/PAI.md)
