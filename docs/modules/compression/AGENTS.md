# Codomyrmex Agents — docs/modules/compression

**Version**: v0.1.0 | **Status**: Active | **Last Updated**: January 2026

## Purpose

Documentation stub for the `compression` module. Primary documentation resides in the source module.
...
- [src/codomyrmex/compression/AGENTS.md](../../../src/codomyrmex/compression/AGENTS.md)
