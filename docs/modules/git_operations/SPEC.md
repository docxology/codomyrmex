...
See [API_SPECIFICATION.md](API_SPECIFICATION.md) and the [source API spec](../../../src/codomyrmex/git_operations/docs/API_SPECIFICATION.md) for the complete function list.
