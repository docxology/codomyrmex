...
**A Modular, Extensible Coding Workspace** — v1.3.0

Welcome to the Codomyrmex documentation. This site covers architecture, tutorials, API
reference, and development guides for a modular ecosystem with **130 top-level modules**
(see [reference/inventory.md](reference/inventory.md)) and **39 agent packages** under
`src/codomyrmex/agents/` (documented under [agents/](agents/)). Quality claims are
scoped to the measured gate and evidence surface named by each page.
...
| [Agent Integrations](agents/)                    | 39 agent packages; Hermes includes [skill registry & MCP preload](agents/hermes/skills.md) |
| [Module Docs](modules/)                          | Per-module README, SPEC, AGENTS docs (130 top-level packages)                              |
