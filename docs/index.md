...
- **Zero-Mock testing** — all tests use real functional verification (**35,916** tests collected with `uv run pytest --collect-only -q --no-cov`; see [inventory](reference/inventory.md))
