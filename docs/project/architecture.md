...
**Purpose**: Autonomous security and economic capabilities

- **`identity`**: 3-Tier persona management and verification
- **`wallet`**: Self-custody wallet and ritual recovery
- **`defense`**: Active defense and exploit containment
- **`market`**: Anonymous economic coordination
