...
- **Ruff** — 0 violations enforced repo-wide (ratcheted v1.0.5). This eliminates entire *syntactic* classes of bugs — unused variables, undefined names, import cycles. Formally: ruff enforces a decidable subset of Python's context-free grammar constraints.
