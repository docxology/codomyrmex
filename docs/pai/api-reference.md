...
| Property | Type | Path |
|----------|------|------|
| `pai_root` | `Path` | `~/.claude/PAI` (v4+; v3 installation: `~/.claude/skills/PAI`) |
| `skill_md` | `Path` | Algorithm SKILL.md |
| `skills_dir` | `Path` | `~/.claude/skills/` |
| `tools_dir` | `Path` | `~/.claude/PAI/Tools/` (v4+; v3 installation: `~/.claude/skills/PAI/Tools/`) |
| `agents_dir` | `Path` | `~/.claude/agents/` |
| `memory_dir` | `Path` | `~/.claude/MEMORY/` |
| `hooks_dir` | `Path` | `~/.claude/hooks/` |
| `security_dir` | `Path` | `~/.claude/PAI/PAISECURITYSYSTEM/` (v4+; v3 installation: `~/.claude/skills/PAI/PAISECURITYSYSTEM/`) |
| `telos_dir` | `Path` | `~/.claude/USER/` |
| `components_dir` | `Path` | `~/.claude/PAI/Components/` (v4+; v3 installation: `~/.claude/skills/PAI/Components/`) |
