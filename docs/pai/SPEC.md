...
| `tools-reference.md` | All 18 static tools with parameters, trust levels; dynamic discovery mechanism |
...
3. **Synchronized**: All counts (18 tools, 10 prompts, 2 resources, 4 destructive) match implementation
