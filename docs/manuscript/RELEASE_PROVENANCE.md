...
- Release tag: `v1.4.0-rc6` (candidate revision is recorded by the tagged clean-clone manifest; `v1.4.0` remains held pending external evaluation)
...
candidate is tagged as `v1.4.0-rc6` and the clean-clone release manifest is
