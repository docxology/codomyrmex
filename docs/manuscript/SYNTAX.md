...
| `{{CONFIG_PARAMETER_STATUS_NOTE}}` | CONFIG | `02_methodology.md`, `02_theory.md`, `03_results.md`, `05_experimental_setup.md`, `06_reproducibility.md`, `07_scope_and_related_work.md`, `08_active_inference.md`, `90_appendix_design_rationale.md` |
