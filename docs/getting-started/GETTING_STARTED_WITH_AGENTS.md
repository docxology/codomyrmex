...
graph TB
    ...
    subgraph MODULES["🐜 Codomyrmex (126 modules)"]
        direction LR
...
Every module exposes functionality through `mcp_tools.py` files. **126 modules** provide **~427 dynamically-discovered tools** plus 20 static tools.
