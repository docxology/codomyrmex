...
|--------|-------|
| Test files | 886 |
| Tests collected | 34,334 (`uv run pytest src/codomyrmex/tests/ --collect-only -q --no-header --override-ini='addopts=' --import-mode=importlib`; see [reference/inventory.md](../../reference/inventory.md)) |
