...
This tutorial walks you through connecting the [PAI system](../../PAI.md) (`~/.claude/PAI/`) to codomyrmex via the Model Context Protocol (MCP). Once connected, PAI agents can use codomyrmex's 130 modules as tools during Algorithm execution.
...
- **Explore modules**: Run `codomyrmex modules` to see all 130 modules
