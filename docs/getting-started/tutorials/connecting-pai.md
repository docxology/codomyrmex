...
This tutorial walks you through connecting the [PAI system](../../PAI.md) (`~/.claude/PAI/`) to codomyrmex via the Model Context Protocol (MCP). Once connected, PAI agents can use codomyrmex's **130** top-level modules as tools during Algorithm execution.
...
4. You should see the 88 module listing
...
- **Explore modules**: Run `codomyrmex modules` to see all top-level modules
