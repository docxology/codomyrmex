# Full Architecture & Setup Guide

This document contains the detailed architecture walkthrough, complete module reference, project structure, and development guide for Codomyrmex. For a quick overview, see the [README](../../README.md).
