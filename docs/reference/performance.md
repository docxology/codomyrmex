...
- **[Monitoring Setup](../deployment/monitoring.md)**: Performance monitoring infrastructure
- **[Testing Strategy](../development/testing-strategy.md)**: Performance testing integration

### **Module-Specific Performance**
- **[Data Visualization Performance](../../src/codomyrmex/data_visualization/docs/performance.md)**: Visualization-specific optimizations
- **[AI Code Editing Performance](../../src/codomyrmex/ai_code_editing/docs/performance.md)**: AI operation optimization
- **[Static Analysis Performance](../../src/codomyrmex/static_analysis/docs/performance.md)**: Code analysis optimization

### **Development Resources**
- **[Development Environment](../development/environment-setup.md)**: Development performance setup
- **[Profiling Guide](../development/profiling.md)**: Code profiling and optimization
- **[CI/CD Performance](../development/ci-cd.md)**: Build and test performance
