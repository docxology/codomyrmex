...
def main() -> int:
    setup_logging()
    print_info("=== API Pagination Demo ===")
    try:
        from codomyrmex.api.pagination import OffsetPaginator
        obj = OffsetPaginator()
        print_success(f"OffsetPaginator loaded: {obj!r}")
        ...
        return 1
    print_success("API Pagination demo complete")
    return 0
