# scripts/examples/basic

**Version**: v0.1.0 | **Status**: Active | **Last Updated**: October 2025

## Overview

Container for the `scripts/examples/basic` agent surfaces and supporting assets.
...
from codomyrmex.scripts.examples.basic import ModuleClass
