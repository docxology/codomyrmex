...
# Output: Comprehensive visualization suite in scripts/output/advanced_data_visualization/
...
OUTPUT_DIR="$PROJECT_ROOT/scripts/output/advanced_data_visualization"
