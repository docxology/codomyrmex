...
def main() -> int:
    setup_logging()
    print_info("=== DB Replication Demo ===")
    try:
        import codomyrmex.database_management.replication as replication
        print_success(f"replication module loaded: version={replication.__version__}")
        ...
        return 1
    print_success("DB Replication demo complete")
    return 0
