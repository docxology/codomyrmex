...
def main() -> int:
    setup_logging()
    print_info("=== Telemetry Sampling Demo ===")
    try:
        import codomyrmex.telemetry.sampling as mod
        print_success(f"sampling module loaded: version={mod.__version__}")
        ...
        return 1
    print_success("Telemetry Sampling demo complete")
    return 0
