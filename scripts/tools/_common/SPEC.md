# _common - Functional Specification
...
Functional requirements for _common including core capabilities and standards.
...
Implementation guidelines for working within _common including best practices and patterns.

## Navigation

- **Human Documentation**: [README.md](README.md)
- **Technical Documentation**: [AGENTS.md](AGENTS.md)
- **Parent Directory**: [tools](../README.md)
