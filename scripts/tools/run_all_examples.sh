...
# Output: Results in scripts/output/ subdirectories
...
show_summary() {
    ...
    if [[ $successful_examples -gt 0 ]]; then
        ...
        local output_base="$PROJECT_ROOT/scripts/output"
    ...
    echo "   1. Review generated outputs in scripts/output/"
...
handle_error() {
    ...
    log_info "You may have partial results in scripts/output/"
    exit 1
}
...
main() {
    ...
    echo "   • Generated files in scripts/output/ directories"
