# SPEC — scripts/testing


**Version**: v0.1.0 | **Status**: Active | **Last Updated**: May 2026

## Purpose
Signpost and optional automation for `testing`. Extend this file when public script CLIs or stable entry points are added.

## Scope
- Library behavior is specified under `src/codomyrmex/testing/` and `docs/modules/testing/`.
