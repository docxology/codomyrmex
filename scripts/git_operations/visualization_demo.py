...
Usage:
    python3 scripts/git_operations/visualization_demo.py [repository_path]
...
def main():
    ...
    if args.repository_path:
        ...
        logger.info("To analyze a real repository, run: python3 scripts/git_operations/visualization_demo.py /path/to/repository")
