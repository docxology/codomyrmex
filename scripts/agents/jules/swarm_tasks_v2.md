...
Review the root README.md. Ensure badges are current, installation instructions work, and the project description accurately reflects current state (**128** top-level modules; **34,492** collected tests — see `docs/reference/inventory.md`).
...
Review src/codomyrmex/SPEC.md for accuracy. Ensure all **128** top-level modules are listed with correct purpose statements, dependency maps, and public API summaries. Cross-reference against the actual module contents.
