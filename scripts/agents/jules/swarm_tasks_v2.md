...
Review the root README.md. Ensure badges are current, installation instructions work, and the project description accurately reflects current state (**128** top-level modules; **34,085** collected tests — see `docs/reference/inventory.md`).
