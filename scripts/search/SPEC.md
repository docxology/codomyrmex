...
## Purpose
Signpost and optional automation for `search`. Extend this file when public script CLIs or stable entry points are added.

## Scope
- Library behavior is specified under `src/codomyrmex/search/` and `docs/modules/search/`.
