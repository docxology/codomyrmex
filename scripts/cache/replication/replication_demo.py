...
def main() -> int:
    setup_logging()
    print_info("=== Cache Replication Demo ===")
    try:
        from codomyrmex.cache import replication
        obj = replication
        print_success(f"replication module loaded: {obj!r}")
        ...
        return 1
    print_success("Cache Replication demo complete")
    return 0
