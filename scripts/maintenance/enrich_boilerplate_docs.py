...
def build_readme(module_name, py_files, sh_files, other_files, subdirs):
    ...
    if main_doc:
        ...
        lines.append(
            f"The `{module_name}` module provides components and workflows within the Codomyrmex ecosystem."
        )
        lines.append("")
    ...
    for root, dirs, files in os.walk(start_dir):
        ...
        try:
            ...
            if BOILERPLATE_SIG in content:
                ...
                py_files, sh_files, other_files, subdirs = get_folder_context(
                    current_dir
                )
                ...
                new_readme = build_readme(
                    module_name, py_files, sh_files, other_files, subdirs
                )
