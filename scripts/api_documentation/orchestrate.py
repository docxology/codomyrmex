...
Thin orchestrator script providing CLI access to api_documentation module functionality.
Calls actual module functions from codomyrmex.api_documentation.
...
from codomyrmex.exceptions import APIDocumentationError, CodomyrmexError
