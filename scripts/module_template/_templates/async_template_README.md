...
cp scripts/_templates/async_template.py scripts/your_async_module/examples/example_basic.py
cp scripts/_templates/async_template_config.yaml scripts/your_async_module/examples/config.yaml
cp scripts/_templates/async_template_README.md scripts/your_async_module/examples/README.md
```
