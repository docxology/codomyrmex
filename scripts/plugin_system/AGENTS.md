# Codomyrmex Agents — scripts/plugin_system
...
- **Development Utilities**: Various development helper plugin_system

### Key Features
- Command-line interface with argument parsing
- Integration with core plugin_system modules
...
Main CLI entry point for the plugin_system orchestrator.
