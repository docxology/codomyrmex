...
- `audits/` – Directory containing audits components
...
- `exploration/` – Directory containing exploration components
...
- `fix_ty_ast.py` – Project file
- `fix_ty_imports.py` – Project file
- `fix_ty_stubborn.py` – Project file
...
- `setup_submodules.sh` – Project file
...
- `verification/` – Directory containing verification components
