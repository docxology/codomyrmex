...
def main() -> int:
    setup_logging()
    print_info("=== Orchestrator Triggers Demo ===")
    try:
        import codomyrmex.orchestrator.triggers as triggers
        print_success(f"triggers module loaded: version={triggers.__version__}")
        ...
        return 1
    print_success("Orchestrator Triggers demo complete")
    return 0
