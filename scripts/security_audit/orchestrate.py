...
Thin orchestrator script providing CLI access to security_audit module functionality.
Calls actual module functions from codomyrmex.security_audit.
...
from codomyrmex.exceptions import SecurityAuditError, CodomyrmexError
