#!/usr/bin/env python3
"""
Networking Module Orchestrator

Thin orchestrator script providing CLI access to networking module functionality.
Calls actual module functions from codomyrmex.networking.
...
def handle_info(args):
    ...
    try:
        if getattr(args, "verbose", False):
            logger.info("Retrieving networking module information")

        info = {
            "module": "networking",
            "description": "Networking utilities",
            "path": getattr(networking, "__path__", ["unknown"])[0],
        }

        print_section("Networking Module Information")
...
Examples:
  %(prog)s info
    ...
    # Info command
    info_parser = subparsers.add_parser("info", help="Get networking module information")
