...
def handle_info(args):
    ...
    try:
        ...
        info = {
            "module": "fabric_integration",
            "description": "Fabric AI + Codomyrmex integration workflows",
            "setup_instructions": [
                "Run: ./scripts/fabric_integration/setup_demo.sh",
                "After setup, use generated orchestrator scripts in scripts/output/fabric-integration/",
            ],
            "location": "scripts/fabric_integration/",
            "output_location": "scripts/output/fabric-integration/",
        }
        ...
        print(f"Output: {info['output_location']}")
