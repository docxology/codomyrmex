#!/usr/bin/env python3
"""
Thin wrapper for generate_dashboard.py.
Logic migrated to codomyrmex.documentation.scripts.generate_dashboard.
"""
...
if __name__ == "__main__":
    ...
    try:
        from codomyrmex.documentation.scripts import generate_dashboard
        if hasattr(generate_dashboard, 'main'):
            sys.exit(generate_dashboard.main())
        else:
        ...
        print(f"Module generate_dashboard does not have a main function or failed to execute.")
        sys.exit(1)
