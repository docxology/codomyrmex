#!/usr/bin/env python3
"""
Thin wrapper for validate_links.py.
Logic migrated to codomyrmex.documentation.scripts.validate_links.
"""
...
try:
    from codomyrmex.documentation.scripts import validate_links
    if hasattr(validate_links, 'main'):
        sys.exit(validate_links.main())
    else:
