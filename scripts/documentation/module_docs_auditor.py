#!/usr/bin/env python3
"""
Thin wrapper for module_docs_auditor.py.
Logic migrated to codomyrmex.documentation.scripts.module_docs_auditor.
"""
...
try:
    from codomyrmex.documentation.scripts import module_docs_auditor
    if hasattr(module_docs_auditor, 'main'):
    ...
    print(f"Module module_docs_auditor does not have a main function or failed to execute.")
    sys.exit(1)
