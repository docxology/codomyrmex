#!/usr/bin/env python3
"""
Thin wrapper for verify_api_specs.py.
Logic migrated to codomyrmex.documentation.scripts.verify_api_specs.
"""
...
try:
    from codomyrmex.documentation.scripts import verify_api_specs
    if hasattr(verify_api_specs, 'main'):
    ...
    print(f"Module verify_api_specs does not have a main function or failed to execute.")
    sys.exit(1)
