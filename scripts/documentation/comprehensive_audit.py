#!/usr/bin/env python3
"""
Thin wrapper for comprehensive_audit.py.
Logic migrated to codomyrmex.documentation.scripts.comprehensive_audit.
"""
...
if __name__ == "__main__":
    ...
    try:
        from codomyrmex.documentation.scripts import comprehensive_audit
        if hasattr(comprehensive_audit, 'main'):
        ...
        print(f"Module comprehensive_audit does not have a main function or failed to execute.")
        sys.exit(1)
