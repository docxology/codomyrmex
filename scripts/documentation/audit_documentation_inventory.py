#!/usr/bin/env python3
"""
Thin wrapper for audit_documentation_inventory.py.
Logic migrated to codomyrmex.documentation.scripts.audit_documentation_inventory.
"""
...
if __name__ == "__main__":
    ...
    try:
        from codomyrmex.documentation.scripts import audit_documentation_inventory
        if hasattr(audit_documentation_inventory, 'main'):
            sys.exit(audit_documentation_inventory.main())
        else:
