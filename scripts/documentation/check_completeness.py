#!/usr/bin/env python3
"""
Thin wrapper for check_completeness.py.
Logic migrated to codomyrmex.documentation.scripts.check_completeness.
"""
...
try:
    from codomyrmex.documentation.scripts import check_completeness
    if hasattr(check_completeness, 'main'):
    ...
    print(f"Module check_completeness does not have a main function or failed to execute.")
    sys.exit(1)
