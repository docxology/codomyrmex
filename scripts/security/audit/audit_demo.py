...
def main() -> int:
    setup_logging()
    print_info("=== Security Audit Demo ===")
    try:
        from codomyrmex.security.audit import AuditLogger
        obj = AuditLogger()
        print_success(f"AuditLogger loaded: {obj!r}")
        ...
        return 1
    print_success("Security Audit demo complete")
    return 0
