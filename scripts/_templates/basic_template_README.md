...
cp examples/_templates/basic_template.py examples/your_module/example_basic.py
cp examples/_templates/basic_template_config.yaml examples/your_module/config.yaml
cp examples/_templates/basic_template_README.md examples/your_module/README.md
```
