...
Batch rationale: mechanical detectors identified structural patterns needing judgment; concern types: coupling_design, design_concern, duplication_design, mixed_responsibilities, systemic_pattern; truncated to 80 files from 503 candidates
...
- scripts/encryption/orchestrate.py
- scripts/environment_setup/env_setup.py
- scripts/exceptions/orchestrate.py
- scripts/feature_store/feature_store_demo.py
- scripts/file_system/fs_utils.py
...
- scripts/scrape/scrape_utils.py
