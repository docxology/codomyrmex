...
**Date:** 2026-07-14
**Candidate:** `v1.4.0-rc10`
**Historical audit anchor:** `v1.4.0-rc1` at `471f998719bcbbdd756cedb66a2d8e95762dd542`
**Current revision:** recorded in the clean-clone manifest for tag `v1.4.0-rc10`
...
RC10 with a publication hold, not a completed production-safety release.
