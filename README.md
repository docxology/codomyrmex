...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-36%2C024-brightgreen?style=flat-square" alt="Tests">
</p>
...
| 🧪 **36,024 Collected Tests** | Complete locked dependency profile; `uv run --locked --all-groups --all-extras python scripts/doc_inventory.py --pytest`; zero-mock policy |
...
| **Collected tests** | 36,024 in the complete locked dependency profile (`uv run --locked --all-groups --all-extras python scripts/doc_inventory.py --pytest`) |
...
<p align="center">
  ...
  <sub>130 modules · 612 runtime MCP tools · 627 decorators · 36,024 tests · 1,204 docs · 37 workflows · Zero-Mock policy · Evidence-scoped</sub>
</p>
