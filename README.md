...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-35%2C782-brightgreen?style=flat-square" alt="Tests">
</p>
...
| 🧪 **35,782 Collected Tests** | Complete locked dependency profile; `uv run python scripts/doc_inventory.py --pytest`; zero-mock policy |
...
| **Collected tests** | 35,782 in the complete locked dependency profile (`uv run python scripts/doc_inventory.py --pytest`) |
...
<p align="center">
  ...
  <sub>130 modules · 608 runtime MCP tools · 623 decorators · 35,782 tests · 1,199 docs · 37 workflows · Zero-Mock policy · Evidence-scoped</sub>
</p>
