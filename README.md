...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-36%2C027-brightgreen?style=flat-square" alt="Tests">
</p>
...
| 🧪 **36,027 Collected Tests** | Complete locked dependency profile; `uv run --locked --all-groups --all-extras python scripts/doc_inventory.py --pytest`; zero-mock policy |
...
| **Collected tests** | 36,027 in the complete locked dependency profile (`uv run --locked --all-groups --all-extras python scripts/doc_inventory.py --pytest`) |
...
<p align="center">
  ...
  <sub>130 modules · 612 runtime MCP tools · 627 decorators · 36,027 tests · 1,204 docs · 37 workflows · Zero-Mock policy · Evidence-scoped</sub>
</p>
