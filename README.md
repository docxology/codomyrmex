...
├── docs/                     # 1,205 Markdown files (see inventory); 18+ top-level sections
...
| **Documentation Files** | 1,205 Markdown under `docs/` (`find docs -name '*.md'`) |
...
<p align="center">
  ...
  <sub>130 modules · 608 runtime MCP tools · 623 decorators · 35,444 tests · 1,205 docs · 37 workflows · Zero-Mock policy · Evidence-scoped</sub>
</p>
