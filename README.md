...
├── docs/                     # 1,168 Markdown files (see inventory); 18+ top-level sections
...
| **Collected tests** | 34,593 (`pytest --collect-only --no-cov`) |
| **Documentation Files** | 1,168 Markdown under `docs/` (`find docs -name '*.md'`) |
