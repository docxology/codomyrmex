...
This document outlines security procedures and policies for the Model Context Protocol module.
...
Instead, please email [MAINTAINER_EMAIL_OR_SECURITY_CONTACT] with the subject line: "SECURITY Vulnerability Report: Model Context Protocol - [Brief Description]".
...
This security policy applies only to the `Model Context Protocol` module within the Codomyrmex project. For project-wide security concerns, please refer to the main project's security policy (if available) or contact the core project maintainers.
...
Thank you for helping keep Codomyrmex and the Model Context Protocol module secure. 