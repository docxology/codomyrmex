...
| ------------------------ | ------------------------- | ------------------ | ------------------------------------------------------------------------------------------------------------- |
| **All collected**        | under `tests/`            | **36,027**         | Complete locked dependency profile; single source of truth: `uv run --locked --all-groups --all-extras python scripts/doc_inventory.py --pytest` |
