...
import pytest
from tests.unit.hermes.hermes_imports import prepare_hermes_imports
...
def _import_plugins_cmd():
    """Import hermes_cli.plugins_cmd from the unified hermes-agent checkout, or skip."""
