...
class TestDocumentationAccuracy:
    ...
    def test_mcp_schemas_exist(self):
        ...
        error = MCPErrorDetail(code="TEST", message="Test error")
        assert error.code == "TEST"
        assert error.message == "Test error"
        
        tool_call = MCPToolCall(tool_name="test_tool", parameters={"param": "value"})
    ...
    def test_repository_management_classes_exist(self):
        ...
        # Test RepositoryType enum exists
        assert hasattr(RepositoryType, 'UNKNOWN')
