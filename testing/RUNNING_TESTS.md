...
|----------|----------|-------|-------------|----------------|
| **Unit Tests** | `testing/unit/` | ~800 | Individual component testing | Fast (< 30s) |
| **Integration Tests** | `testing/integration/` | ~200 | Cross-module workflow testing | Moderate (1-5 min) |
| **Example Tests** | `testing/examples/` | ~150 | Example validation and execution | Moderate (30s-2 min) |
| **Performance Tests** | `testing/performance/` | ~50 | Benchmarking and performance validation | Slow (5-15 min) |
...
uv run pytest testing/unit/ -m "not slow"

# Integration tests
uv run pytest testing/integration/

# Example validation
uv run pytest testing/examples/

# Performance tests (slow)
uv run pytest testing/performance/
```
...
uv run pytest testing/unit/ --collect-only
```
