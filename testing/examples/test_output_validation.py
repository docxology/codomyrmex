...
class TestOutputValidation:
    ...
    def validate_output_completeness(self, output: Dict[str, Any], module_name: str) -> Dict[str, Any]:
        ...
        module_expectations = {
            "api_documentation": ["api_endpoints_documented", "openapi_spec_generated"],
            ...
            "ollama_integration": ["models_loaded", "inference_completed"],
            "language_models": ["providers_configured", "completions_generated"],
            "modeling_3d": ["scenes_created", "rendering_completed"],
