...
class TestCodeExecutionSandbox:
    ...
    def test_code_executor_structure_and_functions(self, code_dir):
        ...
        assert hasattr(code_executor, 'execute_code')
        assert callable(code_executor.execute_code)

        # Test constants and configuration
        assert hasattr(code_executor, 'SUPPORTED_LANGUAGES')
        assert isinstance(code_executor.SUPPORTED_LANGUAGES, dict)
        ...
        assert code_executor.MIN_TIMEOUT <= code_executor.DEFAULT_TIMEOUT <= code_executor.MAX_TIMEOUT
    ...
    def test_supported_languages_configuration(self, code_dir):
        ...
        languages = code_executor.SUPPORTED_LANGUAGES
    ...
    def test_execute_code_function_signature(self, code_dir):
        ...
        sig = inspect.signature(code_executor.execute_code)
    ...
    def test_execution_timeout_validation(self, code_dir):
        ...
        assert 0 < code_executor.MIN_TIMEOUT <= code_executor.DEFAULT_TIMEOUT <= code_executor.MAX_TIMEOUT
        ...
        if code_executor.check_docker_available():
            # Test valid timeout
            result = code_executor.execute_code('python', safe_code, timeout=5)
            assert isinstance(result, dict)

            # Test default timeout (None should use DEFAULT_TIMEOUT)
            result_default = code_executor.execute_code('python', safe_code, timeout=None)
    ...
    def test_execution_limits_dataclass(self):
        ...
        from codomyrmex.code_execution_sandbox.code_executor import ExecutionLimits
    ...
    def test_resource_monitor(self):
        ...
        from codomyrmex.code_execution_sandbox.code_executor import ResourceMonitor
    ...
    def test_execute_with_limits(self):
        ...
        from codomyrmex.code_execution_sandbox.code_executor import execute_with_limits, ExecutionLimits
    ...
    def test_sandbox_process_isolation(self):
        ...
        from codomyrmex.code_execution_sandbox.code_executor import sandbox_process_isolation, ExecutionLimits
