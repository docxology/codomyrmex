...
## 2026-07-11 - Lift static mapping dictionaries to constants
**Learning:** Instantiating static mapping dictionaries (e.g., type maps) inside frequently called functions (like serialization or validation) incurs repeated allocation overhead. Python optimizes this poorly inside function scopes.
**Action:** Define them as class-level or module-level constants (e.g., _TYPE_MAP) to prevent repeated allocation overhead and improve execution speed.
